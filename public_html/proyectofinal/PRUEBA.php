        ...
        <table class="table">
                ...
                While($row = $sql->fetch_assoc()) {   ?>
                        ...
                        <td style= "text-align:center;">
                                <?php 
                                        echo '<a href="./modservicio.php?COD_SERVICIO_BRINDADO='. $row['COD_SERVICIO_BRINDADO'] .'" class="mr-3" title="Modificar Registro" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                ?>
                        </td>
                        </tr>
               <?php } ?>
